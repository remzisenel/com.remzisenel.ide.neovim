...
using UnityEngine;
using NeovimEditor.Editor.Util;
...
namespace NeovimEditor.Editor.ProjectGeneration {
    internal class ProjectGeneration : IGenerator {
        ...
        public bool SyncIfNeeded(IEnumerable<string> affectedFiles, IEnumerable<string> reimportedFiles, bool checkProjectFiles = false) {
            ...
            if (HasFilesBeenModified(affectedFiles, reimportedFiles) || ScriptEditorData.instance.hasChanges
                                                                     || ScriptEditorData.instance.HasChangesInCompilationDefines()
        ...
        public void Sync() {
            ...
            _buffer = null;
            ScriptEditorData.instance.hasChanges = false;
            ScriptEditorData.instance.InvalidateSavedCompilationDefines();
        }
