    ...
    internal static class PackageManagerTracker {
        private static bool HasManifestJsonLastWriteTimeChanged() {
            ...
            if (manifestFile.Exists) {
                ...
                var res = manifestFile.LastWriteTime > ScriptEditorPersistedState.instance.ManifestJsonLastWrite;
                if (res) ScriptEditorPersistedState.instance.ManifestJsonLastWrite = manifestFile.LastWriteTime;
                return res;
            }
